...
const en: Translations = {
  ...
  hero: {
    ...
    sub: "Simple, fully managed IT for small businesses, backed by people who take the time to understand your business.",
    cta: "Let’s talk",
...
const fr: Translations = {
  ...
  hero: {
    ...
    heading2: "à gérer.",
    sub: "IT entièrement géré pour les petites entreprises, par des gens qui prennent le temps de comprendre votre activité.",
    cta: "Parlons-en",
